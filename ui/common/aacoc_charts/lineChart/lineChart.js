aacoc_charts.directive('lineChart', ['$window', '$timeout', function ($window, $timeout) {
    ...
    function renderChart(element, attrs, config) {
        ...
        if (defaults.scaleMaxY !== null) {
            valueMax = defaults.scaleMaxY;
        };
        if (defaults.scaleMinY !== null) {
            valueMin = defaults.scaleMinY;
        };
        ...
        if (defaults.scaleTypeX === "ordinal") {
            ...
            var xAxis = d3.svg.axis()
                ...
                .tickSize(defaults.tickSizeX, 0)
                .tickFormat(function (d) {
                    return d3.format(defaults.formatX)(d).replace('G', 'B');
                })
                .orient("bottom");
        }
        ...
        var yAxis = d3.svg.axis()
            ...
            .tickFormat(function (d) {
                return d3.format(defaults.formatY)(d).replace('G', 'B');
            });
        ...
        if (valueArrays == false) {
            ...
            svg.append("text")
                ...
                .text(function (d) {
                    return defaults.messages.noData;
                })
        } else {
