var myApp = angular.module('myApp', ['ui.router', 'ngMaterial', 'ngResource', 'aacoc-charts', 'ngCookies', 'chart.js', 'nvd3', 'ngMessages', 'angularUtils.directives.dirPagination']);//task001
